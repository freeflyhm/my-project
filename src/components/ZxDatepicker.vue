<style>
  ...
  div.zxdatepicker > button.close:focus {
    opacity: .2;
  }
</style>

<template>
  <div class="zxdatepicker">
    <input class="form-control datepicker-input" :class="{'with-reset-button': showResetButton}" type="text"
        @click="inputClick"
        v-model="computeValue" lazy>
    <button v-if="showResetButton" type="button" class="close" @click="computeValue = ''">
      <span>&times;</span>
    </button>
    <div class="zxdatepicker-popup" v-show="displayDayView">
      <div class="datepicker-inner">
        <div class="datepicker-body">
          ...
          <div class="datepicker-ctrl">
            <p @click="daySelect(new Date(),this)">快速定位到今天</p>
          </div>
        </div>
      </div>
    </div>
    <div class="zxdatepicker-popup" v-show="displayMonthView">
      <div class="datepicker-inner">
        <div class="datepicker-body">
          <div class="datepicker-ctrl">
    ...
    <div class="zxdatepicker-popup" v-show="displayYearView">
      <div class="datepicker-inner">
        <div class="datepicker-body">
          <div class="datepicker-ctrl">
  ...
  methods: {
    ...
    daySelect (date, el) {
      if (el.$el.classList[0] === 'datepicker-item-disable') {
        ...
        this.computeValue = this.stringify(this.currDate)
        this.displayDayView = false
      }
    },
    switchMonthView () {
